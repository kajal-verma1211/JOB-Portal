    ...
    useEffect(() => {
        const fetchSingleJob = async () => {
            try {
                ...
                if (res.data?.success) {
                    console.log('Job data:', res.data.job);  // Add this to inspect job data
    ...
    return (
        <div className='max-w-7xl mx-auto my-10'>
            ...
            <div className='my-4'>
                ...
                <h1 className='font-bold my-1'>
                    Experience: <span className='pl-4 font-normal text-gray-800'>{singleJob?.experienceLevel} yrs</span> {/* Updated */}
                </h1>
                <h1 className='font-bold my-1'>
